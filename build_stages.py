...
stages = [
    ...
    },
    {
        ...
        "avatar": "LEE_JH",
        "dialogue": "죄송합니다 TQO님! 정전의 여파로 서버 콘솔 메모리 버퍼 덤프가 심각하게 깨져버렸습니다(Zalgo 노이즈).\n\n상사분들이 옆에서 잡아먹을 듯이 쳐다보는데 이 덤프가 복구가 안 되면 전 시말서행입니다...\n자세히 들여다보시면 깨진 문자들 사이사이에 정상 데이터의 흔적인 알파벳 B, A, D가 띄엄띄엄 숨어 있는 것을 식별하실 수 있습니다.\n\n이 세 글자를 도출한 뒤, 하단의 아스키(ASCII) 코드표 이미지에서 대문자 B, A, D에 해당하는 10진수 값을 각각 찾아 순서대로 합쳐 입력해 주십시오. 제발 저 좀 살려주십시오!",
        "gimmick_html": "<div class='puzzle-container'>\n    <div class='puzzle-title'>⚠️ CORRUPTED STRING BUFFER</div>\n    <div class='zalgo-box' style='font-family: var(--font-mono); font-size: 1.15rem; letter-spacing: 1px;'>\n        S\\u0337y\\u0337s\\u0337t\\u0337e\\u0337m\\u0337 B\\u0337u\\u0337f\\u0337f\\u0337e\\u0337r\\u0337 A\\u0337n\\u0337o\\u0337m\\u0337a\\u0337l\\u0337y\\u0337 D\\u0337e\\u0337t\\u0337e\\u0337c\\u0337t\\u0337e\\u0337d\\u0337\n    </div>\n    <div style='margin-top: 15px; text-align: center;'>\n        <p style='color: var(--accent-blue); font-size: 0.85rem; margin-bottom: 8px; font-family: var(--font-title);'>📖 ASCII REFERENCE CHART</p>\n        <img src='ascii_table.png' alt='ASCII Code Table' style='max-width: 100%; border: 1px solid var(--border-color); border-radius: 6px; box-shadow: 0 0 15px rgba(0,229,255,0.15);'>\n    </div>\n    <p style='color: var(--text-muted); font-size: 0.85rem; margin-top: 10px; line-height: 1.5;'>\n        힌트: 깨진 덤프의 Buffer, Anomaly, Detected 맨 첫 글자들을 조합한 단어(BAD)의 각 대문자 아스키 10진수 코드값을 표에서 찾아 순서대로 나열하십시오.\n    </p>\n</div>"
    },
    {
        "stage": 6,
