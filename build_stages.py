...
stages = [
    ...
    },
    {
        ...
        "gimmick_html": "<div class='puzzle-container'>\n    <div class='puzzle-title'>🖥️ OS ACTIVE PROCESS MONITOR (TOP/PS DUMP)</div>\n    <table style='width: 100%; border-collapse: collapse; font-family: var(--font-mono); font-size: 0.85rem; text-align: left; color: var(--text-primary); margin-top: 10px;'>\n        <tr style='border-bottom: 1px solid var(--border-color); color: var(--accent-blue);'>\n            <th style='padding: 6px;'>PID</th>\n            <th style='padding: 6px;'>USER</th>\n            <th style='padding: 6px;'>%CPU</th>\n            <th style='padding: 6px;'>%MEM</th>\n            <th style='padding: 6px;'>COMMAND</th>\n        </tr>\n        <tr>\n            <td style='padding: 6px;'>1024</td>\n            <td style='padding: 6px;'>systemd</td>\n            <td style='padding: 6px;'>0.1%</td>\n            <td style='padding: 6px;'>0.2%</td>\n            <td style='padding: 6px;'>/usr/lib/systemd</td>\n        </tr>\n        <tr style='background: rgba(255, 0, 85, 0.15); color: var(--accent-magenta); font-weight: bold;'>\n            <td style='padding: 6px;'>5250</td>\n            <td style='padding: 6px;'>unknown</td>\n            <td style='padding: 6px;'>98.7%</td>\n            <td style='padding: 6px;'>84.2%</td>\n            <td style='padding: 6px;'>/tmp/dummy_exploit_daemon</td>\n        </tr>\n        <tr>\n            <td style='padding: 6px;'>2109</td>\n            <td style='padding: 6px;'>oracle</td>\n            <td style='padding: 6px;'>0.5%</td>\n            <td style='padding: 6px;'>12.4%</td>\n            <td style='padding: 6px;'>oracleHIS (LOCAL=NO)</td>\n        </tr>\n        <tr>\n            <td style='padding: 6px;'>3120</td>\n            <td style='padding: 6px;'>tqo_ops</td>\n            <td style='padding: 6px;'>1.2%</td>\n            <td style='padding: 6px;'>2.1%</td>\n            <td style='padding: 6px;'>python3 diagnostics.py</td>\n        </tr>\n    </table>\n    <p style='color: var(--text-muted); font-size: 0.85rem; margin-top: 12px; line-height: 1.5;'>\n        힌트: CPU 자원의 98% 이상을 폭점하며 임시 경로에서 기동 중인 비정상 프로세스(dummy_exploit_daemon)의 PID 4자리를 찾아 입력하십시오.\n    </p>\n</div>"
    },
    {
        "stage": 8,
