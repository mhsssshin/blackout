...
stages = [
    ...
    },
    {
        ...
        "role": "품질총괄 (예민한 리더)",
        "avatar": "PARK_YC",
        "dialogue": "침입자가 진짜로 WAS 서버에 셧다운 명령을 보냈단 말입니까? 미치겠네...\n\n조사관님! 지금 본부장님이 5분마다 전화해서 SLA 위약금 액수 계산하라고 쪼아대고 계십니다!\n우리가 고객사와 약속한 연간 가동률 하한선이 99.9%예요. 즉 1년 중 시스템 누적 정지 시간이 0.1% 미만이어야 합니다.\n\n이 기준선 무너지면 전 바로 짐 싸야 합니다!\n장애 정지 한계값(525분)에 우리 부서 내부 통제 계수인 10을 곱한 최종 통제 코드 5250이 뚫려버리기 전에, 어서 공식 계산해서 통제 메트릭 입력하세요. 제발 빨리요!",
